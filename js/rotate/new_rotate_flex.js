...
var mouse_rotate_init=function(father_dom,nodes)
    {
       ...
       function mouse_down(event)
        ...
        function auto_translate_rotate(vector_tr,vector_ro,angle)//按照一定的加速度自动完成平移和旋转
        {
        ...
        function mouse_dblclick()//如果点击到node上,则旋转到以该node 为中心,否则恢复到最初的位置
        {
            ...
            auto_translate_rotate(vector_tr,vector_ro,angle);
